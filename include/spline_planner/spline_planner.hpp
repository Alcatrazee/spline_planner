#ifndef __STRAIGHT_LINE_PLANNER_HPP__
#define __STRAIGHT_LINE_PLANNER_HPP__
...
class SplinePlanner : public nav2_core::GlobalPlanner
{
    public: 
    ...
    private:
        ...
        // 插值分辨率
        double interpolation_resolution_,planner_param_;
        int spline_switch_;
        enum{
            BEZIER=0,
            CUBIC_SPLINE=1,
